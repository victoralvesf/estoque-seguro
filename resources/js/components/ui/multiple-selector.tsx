...
interface MultipleSelectorProps {
  ...
  /** Close select after first value is selected. */
  closeAfterFirstSelected?: boolean
  ...
  (
    ...
    const handleUnselect = React.useCallback(
      (option: Option) => {
        ...
        onChange?.(newOptions);
        if (closeAfterFirstSelected && !open) {
            setOpen(true)
    ...
    const blocksInputIfMaxItemsSelected = selected.length === maxSelected && closeAfterFirstSelected
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'flex-1 bg-transparent outline-none placeholder:text-muted-foreground',
                {
                  ...
                  'pointer-events-none': blocksInputIfMaxItemsSelected,
                },
